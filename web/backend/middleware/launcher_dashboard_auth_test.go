...
func TestLauncherDashboardAuth_AllowsPublicPaths(t *testing.T) {
	...
	for _, tc := range []struct {
		...
		{http.MethodHead, "/health", http.StatusTeapot},
		{http.MethodGet, "/ready", http.StatusTeapot},
		{http.MethodHead, "/ready", http.StatusTeapot},
		{http.MethodPost, "/health", http.StatusFound},
		{http.MethodPost, "/ready", http.StatusFound},
