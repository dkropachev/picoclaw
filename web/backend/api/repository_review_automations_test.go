...
func TestRepositoryReviewAutomationCollectionQueryAndPaging(t *testing.T) {
	...
	firstInput.CampaignID = repoaudit.NewRepositoryReviewCampaignID()
	firstInput.Progress.CoverageAvailable = true
	firstInput.Progress.CoverageExact = true
	firstInput.Progress.SelectedFiles = 10
	...
	secondInput.CampaignID = repoaudit.NewRepositoryReviewCampaignID()
	secondInput.Progress.CoverageAvailable = true
	secondInput.Progress.CoverageExact = true
	secondInput.Progress.SelectedFiles = 10
...
func automationConfigBody(automation repoaudit.RepositoryReviewAutomation) map[string]any {
	...
	return map[string]any{
		"name": automation.Name, "repository": automation.Repository, "branch": automation.Ref,
