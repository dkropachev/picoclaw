...
var agentCollectionSchema = mustCollectionQuerySchema(
	[]collectionquery.FieldSchema{
		...
		{Name: "default", Type: collectionquery.TypeBoolean, Sortable: true, SuggestedValues: []string{"true", "false"}},
		{Name: "implicit", Type: collectionquery.TypeBoolean, Sortable: true, SuggestedValues: []string{"true", "false"}},
