...
var p015ReviewedNonLoggingMethodValues = map[string]struct{}{
	...
	p015MethodValueKey("pkg/agent/workflow_runtime.go", "github.com/sipeed/picoclaw/pkg/agent.(*workflowAgentRunner).RunAgent", 4, "req.Output"):                                  {},
	...
	p015MethodValueKey("pkg/agent/workflow_runtime.go", "github.com/sipeed/picoclaw/pkg/agent.(*workflowAgentRunner).RunAgent", 6, "structured.Error"):                            {},
	...
	p015MethodValueKey("pkg/agent/workflow_runtime.go", "github.com/sipeed/picoclaw/pkg/agent.(*workflowAgentRunner).RunAgent", 8, "req.Output"):                                  {},
	...
	p015MethodValueKey("pkg/agent/workflow_runtime.go", "github.com/sipeed/picoclaw/pkg/agent.(*workflowAgentRunner).RunAgent", 11, "structured.Error"):                           {},
