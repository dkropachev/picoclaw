...
| HTTP     | Feature-owned `/api/agents*` routes                                                                                                                                                         | Register ordered agent policy reads and revision-fenced mutations behind launcher authentication, navigation, bounded JSON handling, and gateway restart reporting.                                   | `FR-LAUNCHER-011`                                       |
