...
| `FR-HOOKS-009` | [pkg/agent/hook_mount.go](../../pkg/agent/hook_mount.go), [pkg/agent/hook_mount_test.go](../../pkg/agent/hook_mount_test.go), [pkg/agent/hook_process.go](../../pkg/agent/hook_process.go), [pkg/agent/hook_process_test.go](../../pkg/agent/hook_process_test.go), [pkg/agent/hooks.go](../../pkg/agent/hooks.go) |
