...
| `FR-SEC-058` | [pkg/logger/observation_test.go](../../pkg/logger/observation_test.go), [pkg/logger/observation_adversarial_test.go](../../pkg/logger/observation_adversarial_test.go), [pkg/logger/logger_state_test.go](../../pkg/logger/logger_state_test.go), [pkg/logger/logger_state_unix_test.go](../../pkg/logger/logger_state_unix_test.go) |
