...
| `FR-SEC-058` | [pkg/logger/observation_test.go](../../pkg/logger/observation_test.go), [pkg/logger/observation_adversarial_test.go](../../pkg/logger/observation_adversarial_test.go), [pkg/logger/diagnostic_policy_test.go](../../pkg/logger/diagnostic_policy_test.go), [pkg/logger/safe_fields_test.go](../../pkg/logger/safe_fields_test.go), [pkg/logger/sensitive_preview_test.go](../../pkg/logger/sensitive_preview_test.go), [pkg/logger/logger_state_test.go](../../pkg/logger/logger_state_test.go), [pkg/logger/logger_state_unix_test.go](../../pkg/logger/logger_state_unix_test.go) |
