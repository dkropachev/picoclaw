...
12. Start durable development operation/publication workers only after complete
    ...
    reload or shutdown releases the store client, CI evidence, agent, provider,
    workflow, or Git dependencies; broker pools remain supervisor-owned. Missing review, branch, or issue write capability
