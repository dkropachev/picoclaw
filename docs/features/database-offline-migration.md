...
- Adapter callbacks receive only an authorized disposable stage and disposable
  legacy copies reconstructed from the verified backup.
...
readiness, broker startup, IPC dispatch, or application persistence.
