...
construction. Generation-owned MCP/discovery, Seahorse, install-skill, and
recursion catalogs use the same factory contracts and the atomic multi-registry
installer while current root execution and shallow SubTurn cloning remain
unchanged.
