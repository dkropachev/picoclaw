...
| HTTP | `GET`, `PUT /api/reviews/attention-policies` | Authenticated bounded policy-only projection and same-origin strict full replacement, fenced by the opaque public-plus-security revision and persisted by an atomic raw public-JSON patch that leaves unrelated values and the security sidecar unchanged. | `FR-EVENT-AUTOMATION-046` |
...
| `FR-EVENT-AUTOMATION-046` | [pkg/config/reviews_test.go](../../pkg/config/reviews_test.go), [pkg/config/migration_test.go](../../pkg/config/migration_test.go), [pkg/config/mutation_test.go](../../pkg/config/mutation_test.go), [pkg/reviews/attention_config_test.go](../../pkg/reviews/attention_config_test.go), [pkg/gateway/review_attention_test.go](../../pkg/gateway/review_attention_test.go), [web/backend/api/review_attention_policies_test.go](../../web/backend/api/review_attention_policies_test.go), [web/backend/api/gateway_test.go](../../web/backend/api/gateway_test.go) |
