...
filesystem boundary and untrusted-context prompt contract. A later development
session owns user-visible orchestration, while local review/CI and publication
must independently fence the resulting checkout and current provider state.
