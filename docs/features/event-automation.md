...
| Provider refresh/write, push/publication, acknowledgement, and merge | `#124+` | Receives no authority from the schema-v15 decision link, schema-v16 occurrence, private workflow run, completed attempt, ledger row, gate answer, or review outcome without its own later provider and publication fences. |
