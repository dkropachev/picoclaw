...
retention policies. It deletes only migration-audited, digest-matching imported
repository/automation archives represented by the confirmed inventory; skipped,
