...
| OpenWrt routers | Apenas builds ARM; MIPS não é compatível |
| FreeBSD | Builds x86_64 e arm64 disponíveis |
...
Builds disponíveis: `linux-amd64`, `linux-arm64`, `linux-arm`, `linux-riscv64`, `linux-loong64`
