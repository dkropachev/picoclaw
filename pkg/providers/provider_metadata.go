...
var modelProviderOptionsByName = map[string]ModelProviderOption{
	...
	"github-copilot": {
		...
		Local:              true,
		Priority:           55,
		CommonModels:       []string{"gpt-5.4", "gpt-4.1"},
...
// buildModelProviderAliasMap is retained as a catalog-consistency helper for
// tests. Runtime normalization lives in protocoltypes so config validation can
// share provider identity without importing the providers package.
