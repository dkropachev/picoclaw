...
func validateSchemaV17(ctx context.Context, conn *sql.Conn) error {
	...
	unique := []schemaUniqueIndexSpec{
		...
		{name: "pr_development_controller_suspensions_active", origin: "c", partial: true, columns: []schemaIndexColumn{binary("controller_id")}},
		{name: "pr_development_controller_suspensions_ordinal", origin: "c", columns: []schemaIndexColumn{binary("controller_id"), binary("ordinal")}},
		{name: "pr_development_controller_suspensions_source", origin: "c", columns: []schemaIndexColumn{binary("source_kind"), binary("source_recovery_id")}},
		{name: "pr_development_controller_suspensions_operation", origin: "c", partial: true, columns: []schemaIndexColumn{binary("source_operation_id")}},
		{name: "pr_development_controller_suspensions_suspend_intent", origin: "c", columns: []schemaIndexColumn{binary("suspend_intent_id")}},
		{name: "pr_development_controller_suspensions_intent_hash", origin: "c", columns: []schemaIndexColumn{binary("intent_hash")}},
		{name: "pr_development_controller_suspensions_suspend_bearer", origin: "c", partial: true, columns: []schemaIndexColumn{binary("suspension_reservation_key")}},
		{name: "pr_development_controller_suspensions_suspend_bearer_digest", origin: "c", columns: []schemaIndexColumn{binary("suspension_reservation_digest")}},
		{name: "pr_development_controller_suspensions_suspend_claim", origin: "c", partial: true, columns: []schemaIndexColumn{binary("suspend_claim_id")}},
		{name: "pr_development_controller_suspensions_hash", origin: "c", partial: true, columns: []schemaIndexColumn{binary("suspension_hash")}},
		{name: "pr_development_controller_suspensions_final_hash", origin: "c", partial: true, columns: []schemaIndexColumn{binary("suspension_final_hash")}},
		{name: "pr_development_controller_suspensions_resume_intent", origin: "c", partial: true, columns: []schemaIndexColumn{binary("resume_intent_id")}},
		{name: "pr_development_controller_suspensions_resume_intent_hash", origin: "c", partial: true, columns: []schemaIndexColumn{binary("resume_intent_hash")}},
		{name: "pr_development_controller_suspensions_resume_bearer", origin: "c", partial: true, columns: []schemaIndexColumn{binary("resume_reservation_key")}},
		{name: "pr_development_controller_suspensions_resume_bearer_digest", origin: "c", partial: true, columns: []schemaIndexColumn{binary("resume_reservation_digest")}},
		{name: "pr_development_controller_suspensions_resume_claim", origin: "c", partial: true, columns: []schemaIndexColumn{binary("resume_claim_id")}},
		{name: "pr_development_controller_suspensions_rotation_hash", origin: "c", partial: true, columns: []schemaIndexColumn{binary("rotation_hash")}},
		{name: "pr_development_controller_suspensions_resume_final_hash", origin: "c", partial: true, columns: []schemaIndexColumn{binary("resume_final_hash")}},
	}
