...
var (
	...
	_ PRDevelopmentControllerSuspendedResumeRecoveryStore = (*Store)(nil)
...
func (*Store) NextPRDevelopmentControllerSuspendedResumeRecovery(
	context.Context,
...
func (*Store) ClaimPRDevelopmentControllerSuspendedResumeRecovery(
	context.Context,
...
func (*Store) RenewPRDevelopmentControllerSuspendedResumeRecovery(
	context.Context,
...
func (*Store) FinalizePRDevelopmentControllerSuspendedResumeRecovery(
	context.Context,
...
func (*Store) AuthenticateClaimedPRDevelopmentPublicationGate(
	context.Context,
	string,
	string,
	int64,
) (PRDevelopmentPublicationGateAuthentication, error) {
	return PRDevelopmentPublicationGateAuthentication{}, ErrUnsupportedPlatform
}

func (*Store) AuthenticateClaimedPRDevelopmentPublicationPush(
	context.Context,
	string,
	string,
	int64,
) (PRDevelopmentPublicationPushAuthentication, error) {
	return PRDevelopmentPublicationPushAuthentication{}, ErrUnsupportedPlatform
}
